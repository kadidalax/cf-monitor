...
Run local deployment coverage:

```bash
npm run local-deploy:test
```

This validates a large local data set including:

- 48 nodes
- 44 public nodes
- 4 hidden nodes
- 3468 monitor history rows
- 300 GPU history rows
- 3084 ping history rows
...
docs/       analysis and local deployment notes
```
